...
document.addEventListener("DOMContentLoaded", function() {
  ...
  lazyVideo.setAttribute('data-src', 'https://www.youtube.com/embed/tJQmXxqACAc?si=yuvkFoasN1C1ESYQ');
 ...
 $( document ).ready(function() {
  ...
  const setActiveStyle = (index) => {
    ...
    bgArrows.forEach((bgArrow, i) => {
      bgArrow.style.backgroundColor = i === index ? "#FED606" : "#5CB0DE";
    });
  ...
  bgArrows.forEach((bgArrow, i) => {
    bgArrow.style.backgroundColor = "#5CB0DE";
  });
